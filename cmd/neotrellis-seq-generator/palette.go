...
func generatePalette(rootDir string) error {
	colorsHPath := filepath.Join(rootDir, "src", "colors.h")
	...
	var sb strings.Builder
	sb.WriteString(`// Code generated by cmd/neotrellis-seq-generator (palette); DO NOT EDIT.
...
#endif
`)
	return writeGeneratedCHeader(colorsHPath, []byte(sb.String()))
}
